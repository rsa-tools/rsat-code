################################################################
## Playing with Pseudomonas promoters

include ${RSAT}/makefiles/util.mk
MAKEFILE=makefiles/ortho_disco.mk
...
## interest (${TAXON})
#MAIN_DIR=`pwd`
MAIN_DIR=${HOME}/research/collaborations/Ildefonso_Cases
GENE=putA
#REF_ORG=Escherichia_coli_K12
REF_ORG=Pseudomonas_putida_KT2440
TAXON=Pseudomonadales
...
dyad_file_list:
	...
	@echo ${DYAD_FILE_LIST}
	@echo `wc ${DYAD_FILE_LIST}`

compare_dyads: dyad_file_list
	@mkdir -p ${COMPA_DIR}
...
from_scmbb:
	...
	jvanheld@merlin.scmbb.ulb.ac.be:research/collaborations/Ildefonso_Cases .)

to_scmbb:
	(cd ..; rsync -ruptvlz -e ssh ${OPT} Ildefonso_Cases jvanheld@merlin.scmbb.ulb.ac.be:research/collaborations/)
