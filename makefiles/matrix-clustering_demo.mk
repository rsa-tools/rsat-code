...
cluster_HOMER_MEME_RSAT_Oct4_motifs:
	...
	${MAKE} _cluster MATRIX_PREFIX=${MULTI_ALGO_PREFIX} \
		...
		MATRICES="-matrix MEME ${RSAT}/public_html/demo_files/MEME_ChIP_Oct4_matrices.tf tf -matrix Homer ${RSAT}/public_html/demo_files/Homer_l13_mis3_hyper_Oct4_matrices.tf tf -matrix RSAT ${RSAT}/public_html/demo_files/RSAT_peak-motifs_Oct4_matrices.tf tf"
...
cluster_peakmotifs_Oct4:
	...
	${MAKE} _cluster MATRIX_PREFIX=${OCT4_PREFIX} \
		...
		MATRICES="-matrix MEME ${RSAT}/public_html/demo_files/MEME_ChIP_Oct4_matrices.tf tf"
