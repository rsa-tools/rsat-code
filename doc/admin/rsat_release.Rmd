...
- **tar_archive_scripts** Create a tar archive restricted to the installation scripts. This is a light file which can contains the required for a Web installation of RSAT.

- **tar_archive** Create a tar archive with the full RSAT code.
...
- **publish_scripts** transfer the scripts archive on the release Web site (via password-protected ssh).
