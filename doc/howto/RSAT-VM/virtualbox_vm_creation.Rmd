...
Ubuntu Desktop: current RSAT-VM releases are based on Ubuntu 17.04, but the inscallation procedure works on earlier versions (maybe some slight modifications).
...
- **Ubuntu 16.04.2 LTS (Xenial Xerus):** [ubuntu-16.04.3-desktop-amd64.iso](http://releases.ubuntu.com/releases/16.04/ubuntu-16.04.3-desktop-amd64.iso) (1.4Gb).
...
- File location and size
    ...
    - name of virtual hard drive file:    RSAT-VM-2017-10_HDD
    - max size of virtual hard drive:	    18 GB
...
Depending on your system, you may need to set up advanced option **for Wi-Fi connection**. 
...
![Advanced settings to enable bridged network via a Wi-Fi connection](images/bridged_ethernet_allowall.png)
...
| Your computer's name | rsat-vb-2017-10 |
...
|	Version		  | 2017-10 |
|	Description	| Regulatory Sequence Analysis Tools (RSAT, http://rsat.eu/), installed on an Ubuntu 17.04 Virtual Machine. |
...
time split -b ${SPLIT_SIZE} ${SOURCE_DIR}/rsat-vm-2017-10_${VERSION}.ova ${TARGET_DIR}/appliances/rsat-vm-2017-10_${VERSION}.ova.split${SPLIT_SIZE}_
```
