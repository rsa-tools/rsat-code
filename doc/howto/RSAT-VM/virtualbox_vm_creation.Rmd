...
Ubuntu Desktop:  [ubuntu-17.04-desktop-amd64](http://releases.ubuntu.com/releases/17.04/ubuntu-17.04-desktop-amd64.iso) (1.5Gb).

Lighter alternative (without graphical Ubuntu interface): Ubuntu Server Version 17.04: [ubuntu-17.04-server-amd64](http://releases.ubuntu.com/releases/17.04/ubuntu-17.04-server-amd64.iso) (685Mb).
