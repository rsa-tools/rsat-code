...
% be liable to the \Licensee for any loss, claim or demand made by the
% \Licensee or made against the \Licensee by any third party, due to or
% arising form the use of RSAT by the \Licensee, except to the extent
...
An Email describing how to download \RSAT shall be send by \Licensor to 
