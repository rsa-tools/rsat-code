...
\item \Licensee is authorized to use \RSAT/\NeAT on all computers at the
...
\item \Licensee may not copy \RSAT/\NeAT, or any part thereof in any form,
...
placed upon or contained within \RSAT/\NeAT and any related materials.

\item \Licensee may not sell, rent, sublicense, or otherwise
distribute in any manner whatsoever \RSAT/\NeAT, or any part thereof, or any
...
ownership in \RSAT/\NeAT, and no property rights in any 
...
\Paragraph{Non-military usage} {\RSAT/\NeAT shall not be used for any research 
...
\Paragraph{Non-commercial usage} {\RSAT/\NeAT shall not be used for any commercial 
usage. The results obtained by using the analysis tools included in
\RSAT/\NeAT cannot be sold in any form.
}
...
To ensure that we have received the FAX, please send an E-mail to \\
\JvHemail
