...
sequence sizes of the files \file{PHO_up800.fasta}, and
\file{PHO_up800-noorf.fasta}, respectively.
...
\textt{$\backslash$d+}, indicates that we accept a succession of one
