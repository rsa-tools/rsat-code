...
\begin{exercise}
  ...
  \program{oligo-analysi} and \program{pattern-assembly}.
\end{exercise}
...
\begin{exercise}
  ...
  retrieval. Analyze the results of \program{oligo-analysi} and
...
% {\color{Blue} \begin{footnotesize} 
% \begin{verbatim}
% oligo-analysis -v 1 -format filelist -i $RSAT/data/genomes/Escherichia_coli_K12/genome/contigs.txt -return occ,proba,zscore,rank -two_tail -l 6 -sort -o Escherichia_coli_K12_genome_6nt-2str-noov -2str -noov -markov 3
% \end{verbatim} \end{footnotesize}
% }
