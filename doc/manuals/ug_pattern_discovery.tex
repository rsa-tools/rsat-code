...
oligo-analysis -i PHO_up800.fasta -format fasta    \
    ...
    -o PHO_up800_6nt-2str-noov_ncf_sig0 
\end{verbatim}
...
\begin{verbatim}
more PHO_up800_6nt-2str-noov_ncf_sig0
\end{verbatim}
...
\begin{verbatim}
pattern-assembly -i PHO_up800_6nt-2str-noov_ncf_sig0 \
    -v  1 -subst 1 \
    -2str -o PHO_up800_6nt-2str-noov_ncf_sig0.asmb
\end{verbatim}
...
patterns. The first alignment contains the motif CACGTG, which
corresponds to the high affinity binding site for Pho4p, the protein
controlling transcriptional response to Phosphate in yeast. the second
alignment  corresponds to the medium affinity binding site
for Pho4p. Medium affinity binding sites have been shown to
participate in the transcriptional response to some PHO genes.

\begin{verbatim}
more PHO_up800_6nt-2str-noov_ncf_sig0.asmb
\end{verbatim}
...
\begin{verbatim}
oligo-analysis -i PHO_up800.fasta -format fasta -v 1 \
