...
\program{get-orthologs}. This program takes as input on or several
query genes belonging to a given organism (the \concept{reference
  organsm}), and return the genes whose product (peptidic sequence)
...
The program \program{get-othologs} allows to return additional
