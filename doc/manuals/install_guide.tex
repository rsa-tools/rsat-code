...
\item Open a terminal, set your working directory to the folder
  \file{rsat} extracted from this archive, and run the \RSAT
...
\file{public_html/web_services/RSATWS.wsdl}
...
After this, you shoudl re-generate the web services stubb.
...
\subsubsection{Supported organisms}
...
Get the list of organisms supported on the server \url{http://rsat.fr/}. 
