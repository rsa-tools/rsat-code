...
\program{get-ensembl-genome.pl}, require the EnsEMBL Perl API and
...
\file{DBD::mysql}, which can be installed with cpan (for this you need
root privileges).
...
\item Add the path of the \RSAT \ perl scripts, python scripts and binaries to your
  path.
