...
You need to update the file \file{RSAT\_config.props} and specify the
...
Alternatively, you can edit the file \file{RSAT\_config.props} with a
...
\program{yes} to automatically answer each question by a carriage return, which will lead \program{cpan} to chose the default option.
