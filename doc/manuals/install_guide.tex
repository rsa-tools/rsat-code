...
%% \begin{enumerate}
%%   \item Download the compressed tar archive from the \RSAT
%%     distribution site, uncompress it.
%%     \begin{lstlisting}
%% tar -xpzf rsat_yyyymmdd.tar.gz
%%     \end{lstlisting}


%%   \item Open a terminal and set your working directory to the
%%     folder \file{rsat} extracted from this archive.

%%   \item Run the \RSAT configuration script
%%     \begin{lstlisting}
%% perl perl-scripts/configure_rsat.pl
%%     \end{lstlisting}
    
%%   \item Install the required Perl libraries (see below)
%% \end{enumerate}
