...
can uncompress the \texttt{.tar.gz} archive with the \program{gunzip}
and \program{tar} commands, which are part of the default unix
installation.
...
\file{supported\_organisms.pl} in order to delete the specification of
other genomes. 
