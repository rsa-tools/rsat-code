...
\item \program{SOAP::WSDL}, \program{Module::Build::Compat} and
  ...
  server. Some Perl scripts of the \RSAT stand-alone commands are
  using SOAP to connect remote servers
  (e.g. \program{supported-organisms}, \program{download-organism}).
