...
You need to indictate your \program{cvs} client to use \program{ssh}
...
line to the \file{.cshrc} file in your home directory.
...
to the \file{.bashrc} file in your home directory.
