...
\begin{verbatim}
cd ${RSAT}/public_html/data/genomes/Saccharomyces_cerevisiae/
ls -l
\end{verbatim}

The folder \file{genome} contains the sequence files and the tables
describing the organism and its features (CDSs, mRNAs, \ldots).
