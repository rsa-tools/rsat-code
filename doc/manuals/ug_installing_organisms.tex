...
\subsubsection{Updating the configuration file}
...
\subsubsection{Checking the start and stop codons with \program{install-organisms}}
...
\subsubsection{Calibrating oligonucleotide and dyad frequencies with \program{install-organisms}}
