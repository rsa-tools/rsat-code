...
\chapter{Installing genomes from  NCBI or EMBL}
...
Instead of downloading genomes from the NCBI site, we will use a
mirror \urlref{bio-mirror.net/biomirror/ncbigenomes/} which presents
two advantages:
\begin{itemize}
