...
################################################################
## IN CASE SOME MODULES ARE MISSING, they can be installed with the
following commands, but this requires admin rights.
...
\item If you dispose of admin rights, you can copy the content of this
  ...
  \item in Lunix (Centos or Ubuntu), you can add a soft link
    ...
    completion directory: \file{/etc/bash_completion.d/};
