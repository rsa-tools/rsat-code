...
<?
  ...
  <tr><td><label><input type='checkbox' name='members' value='on' /> Members </label></td></tr></table>
  <tr><td><label><input type='checkbox' name='dotproduct' value='on' /> Dotproduct <i> (Only relevant if a score column is specified)</i></label></td></tr></table>");
  echo("<br><br>");
  ...
  echo("<table border='0' cellspacing='0' cellpadding='0'>
        ...
        <tr align='left' valign='TOP'><td> Significance </td> <td><input type='text' name='lth_sig' value='0' size='5' /></td> <td><input type='text' name='uth_sig' value='none' size='5' /></td></tr> 
        ...
        <tr align='left' valign='TOP'><td> Dot product </td> <td><input type='text' name='lth_dp'  size='5' /></td> <td><input type='text' name='uth_dp'  size='5' /></td><td><i> (Only relevant if a score column is specified)</i></td></tr>
        </table><br>");
