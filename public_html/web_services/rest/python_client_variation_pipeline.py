...
data['i_string'] = json_res['result_path']
data['i_string_type'] = 'piping'
data['format'] = 'varBed'
...
# variation-scan
data = {'species':'Homo sapiens', 'assembly':'GRCh38','m_string':'http://rsat-tagc.univ-mrs.fr/flask/variation_scan_matrix.tf', 'm_format':'tf','m_string_type':'url', 'i_string':json_res['result_path'],'i_string_type':'piping'}
