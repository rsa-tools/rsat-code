...
files = {'tmp_input_file': open('/Users/thnguyen/rsat/public_html/demo_files/fetch-sequences_Schmidt_2011_mm9_CEBPA_SWEMBL_R0.12_702peaks.bed', 'rb')}

r = requests.Request('POST', rsat_server, files=files, data=data).prepare()
s = requests.Session()
resp = s.send(r)
print resp.text
######## END EXAMPLE
