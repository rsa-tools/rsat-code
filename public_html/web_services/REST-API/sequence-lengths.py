...
data =  {
        "i_string" : "http://rsat-tagc.univ-mrs.fr/rsat//tmp/www-data/2021/01/26/retrieve-seq_2021-01-26.033418_yvhnrG.fasta", ##Input string specifying the query. The value can be the query content, the URL of a file available on some Web server, the internal path of the result file returned by another tool of this RSAT server (piping for workflows)
        "i_string_type" : "url", ##Type of information provided by the input string. Available values : text, url, piping.
        "unit" : "kb", ##String. Units for sequence lengths. Supported - bp,kb,mb,gb 
