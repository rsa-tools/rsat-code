...
data =  {
        "i_string" : "http://rsat-tagc.univ-mrs.fr/rsat//tmp/www-data/2021/02/13/convert-matrix_2021-02-13.035737_SlaBhR_input.tab", ##Input string specifying the query. The value can be the query content, the URL of a file available on some Web server, the internal path of the result file returned by another tool of this RSAT server (piping for workflows).
