<html>
<head>
   <title>NeA-tools - graph-topology</title>
...
//   require ('demo_dataset.php');
  ...
  <tr><td><input type='checkbox' name='betweenness' value='on' $default_closeness/></td><td><B>Closeness</B></td><td rowspan = 2><b>Warning</b> May be time consumming depending on the number of nodes of the graph</td></tr>
  <tr><td><input type='checkbox' name='closeness' value='on' $default_betweenness/></td><td><B>Betweenness</B></td><tr>
  </table><br>");
