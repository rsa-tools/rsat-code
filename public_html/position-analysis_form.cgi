...
### $demo_seq_file = "$RSA/public_html/data/demo_files/all_yeast_downstream_200bp.fasta.gz";
$demo_seq_file = "$RSA/public_html/data/demo_files/Mycoplasma_genitalium_upstream_-30_+29.fasta.gz";
