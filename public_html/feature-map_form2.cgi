...
<div class="container">
        ...
        <div class="col-lg-9 col-md-5 col-sm-8 col-xs-9 bhoechie-tab-container">
            <div class="col-lg-2 col-md-3 col-sm-3 col-xs-3 bhoechie-tab-menu">
              <div class="list-group">
                ...
                <a href="#" class="list-group-item text-center">
                  <h4 class="glyphicon"><i class="fa fa-tasks fa-2x"></i></h4><br/>Feature map
                </a>
                <a href="#" class="list-group-item text-center">
 ...
 <!-- ### info ### -->
                ...
                <div class="bhoechie-tab-content active">
					...
					Raul Ossio, Daniela Robles-Espinoza, Morgane Thomas-Chollier, Jacques van Helden<br>
...
<div class="panel panel-danger">
 <div class="panel-heading">Analysis Title</div>
...
#Metric selected to build the hierarchical tree
 ...
 <label for='metric' class='col-sm-5 control-label'>Metric to build the tree <A class='badge badge-primary iframe' HREF='help.matrix-clustering.html#hclust_method'>Info</a></label>\n";
...
print "<div class='form-row'>
 <label for='hclust_method' class='col-sm-5 control-label'>Agglomeration rule <A class='badge badge-primary iframe' HREF='help.matrix-clustering.html#hclust_method'>Info</a></label>\n";
  print "<div class='col-sm-5'>";
...
print "<div class='form-row'>
 <label for='merge_stat' class='col-sm-5 control-label'>Merge matrices <A class='badge badge-primary iframe' HREF='help.matrix-clustering.html#merge_operator'>Info</a></label>\n";
  print "<div class='col-sm-5'>";
