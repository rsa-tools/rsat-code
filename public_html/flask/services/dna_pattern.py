...
class VariationInfo(Resource):
	...
	def _run(self, data):
		...
		boolean_var = ['noIUPAC', 'noid', 'noov', '2str', '1str', 'R', 'id', 'merge', 'top', 'sort']		
		for param in data:
		...
		return utils.run_command(command, output_choice, tool, 'dnapat', result_dir)
