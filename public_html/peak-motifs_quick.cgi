...
&RSA_header("peak-motifs_quick result", "results");
...
## peak-motifs command
$command = "$ENV{RSAT}/perl-scripts/peak-motifs_quick";
...
### read parameters
$parameters = " -v 1";
$parameters .= " -r_plot" if ($query->param("r_plot"));
...
my $mail_title = join (" ", "[RSAT]", "peak-motifs_quick", &AlphaDate());
