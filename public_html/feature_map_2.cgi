...
&print_html( $title, $json_URL , $file_name, $title_position, $view_scalebar, $legends_position);
...
sub print_html{
	my ( $title, $json_URL, $file_name, $title_position, $view_scalebar, $legends_position) = @_;
	#print( "Title " . $title . ", ". "path " . $json_URL . "          $title_position" . "$legends_position" ."$view_scalebar");
