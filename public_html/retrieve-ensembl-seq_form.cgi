...
$default{maskcoding} = "checked";
#$default{imp_pos} = "checked";
$default{from} = "-2000";
$default{to} = "-1";
$default{prevent_overlap} = "genes";
...
print $query->hidden(-name=>'organism',-default=>"Homo_sapiens");
print $query->hidden(-name=>'organism_name',-default=>"Homo sapiens");
print $query->hidden(-name=>'from',-default=>"-2000");
print $query->hidden(-name=>'to',-default=>"-1");
#print $query->hidden(-name=>'noorf',-default=>"");
print $query->hidden(-name=>'maskcoding',-default=>"");
