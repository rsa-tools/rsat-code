package MyTypes::RetrieveSequenceMultigenomeResponse;
use strict;
use warnings;
...
MyTypes::RetrieveSequenceMultigenomeResponse

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
RetrieveSequenceMultigenomeResponse from the namespace urn:RSATWS.
