...
sub START {
    $_[0]->set_proxy('http://mamaze.ulb.ac.be/rsat/web_services/RSATWS.cgi') if not $_[2]->{proxy};
...
located at http://mamaze.ulb.ac.be/rsat/web_services/RSATWS.cgi.
...
Generated by SOAP::WSDL on Mon Jan 30 16:39:40 2012
