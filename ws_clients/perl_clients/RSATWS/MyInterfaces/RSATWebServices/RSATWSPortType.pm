...
sub START {
    $_[0]->set_proxy('http://rsat01.biologie.ens.fr/rsat//web_services/RSATWS.cgi') if not $_[2]->{proxy};
...
located at http://rsat01.biologie.ens.fr/rsat//web_services/RSATWS.cgi.
...
Generated by SOAP::WSDL on Sun Jan 25 17:51:24 2015
