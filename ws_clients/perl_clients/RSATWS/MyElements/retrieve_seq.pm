...
package MyElements::retrieve_seq;
use strict;
use warnings;
...
__PACKAGE__->__set_name('retrieve_seq');
...
MyElements::retrieve_seq

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
retrieve_seq from the namespace urn:RSATWS.
...
=head2 new
 ...
 my $element = MyElements::retrieve_seq->new($data);
