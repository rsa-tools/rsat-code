...
package MyElements::graph_topology;
use strict;
use warnings;
...
__PACKAGE__->__set_name('graph_topology');
...
MyElements::graph_topology

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
graph_topology from the namespace urn:RSATWS.
...
=head2 new
 ...
 my $element = MyElements::graph_topology->new($data);
