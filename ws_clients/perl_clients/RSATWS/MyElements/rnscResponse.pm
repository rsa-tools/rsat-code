...
package MyElements::rnscResponse;
use strict;
use warnings;
...
__PACKAGE__->__set_name('rnscResponse');
...
MyElements::rnscResponse

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
rnscResponse from the namespace urn:RSATWS.
...
=head2 new
 ...
 my $element = MyElements::rnscResponse->new($data);
