...
package MyElements::convert_seq;
use strict;
use warnings;
...
__PACKAGE__->__set_name('convert_seq');
...
MyElements::convert_seq

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
convert_seq from the namespace urn:RSATWS.
...
=head2 new
 ...
 my $element = MyElements::convert_seq->new($data);
