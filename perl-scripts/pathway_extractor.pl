...
############################################################
#
# $Id: pathway_extractor.pl,v 1.8 2011/06/22 07:35:28 rsat Exp $
#
############################################################
...
if ($seednum > 1) {
  ...
  #   chomp($tempfilename);
    ...
    my $pathway_infer_cmd = "java -Xmx1000M graphtools.algorithms.Pathwayinference -i $seed_converter_filename -m 5 -f flat -n -E $outdir -p $outdir -b -d -g $graphfile -y con -v -o $predicted_pathway_filename";
