...
############################################################
#
# $Id: pathway_extractor.pl,v 1.16 2011/07/27 14:35:51 rsat Exp $
#
############################################################
...
see Pathwayinference tools help
...
package main;
{
  ...
  $program_version = do { my @r = (q$Revision: 1.16 $ =~ /\d+/g); sprintf "%d."."%02d" x $#r, @r };
