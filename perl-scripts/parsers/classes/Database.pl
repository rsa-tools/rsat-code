...
package PFBP::Database;
{
  my $data_dir = $parsed_data;
  my $mldbm_dir = "$data_dir/mldbm/";
  
  my %name_index_file = ();
  $name_index_file{"PFBP::ECSet"} = "$data_dir/ec/ECSet__name_index.mldbm";
  $name_index_file{"PFBP::Compound"} = "$data_dir/compounds/Compound__name_index.mldbm";
  $name_index_file{"PFBP::Reaction"} = "$data_dir/reactions/Reaction__name_index.mldbm";
  $name_index_file{"PFBP::Reactant"} = "$data_dir/reactions/Reactant__name_index.mldbm";

  $name_index_file{"PFBP::Gene"} = "$data_dir/genes/Gene__name_index.mldbm";
  $name_index_file{"PFBP::Expression"} = "$data_dir/genes/Expression__name_index.mldbm";

  $name_index_file{"PFBP::Polypeptide"} = "$data_dir/polypeptides/Polypeptide__name_index.mldbm";
#  $name_index_file{"PFBP::Catalysis"} = "$data_dir/polypeptides/Catalysis__name_index.mldbm";

  my %input_index_file = ();
  $input_index_file{"PFBP::Expression"} = "$data_dir/genes/Expression__input_index.mldbm";
  
  my %output_index_file = ();
  $output_index_file{"PFBP::Expression"} = "$data_dir/genes/Expression__output_index.mldbm";
  
  my %equaton_index_file = ();
  $equation_index_file{"PFBP::Reaction"} = "$data_dir/reactions/Reaction__equation_index.mldbm";
  
  my %class_file = ();
  $class_file{"PFBP::ECSet"} = "$data_dir/ec/ECSet.mldbm";
  $class_file{"PFBP::Compound"} = "$data_dir/compounds/Compound.mldbm";
  $class_file{"PFBP::Reaction"} = "$data_dir/reactions/Reaction.mldbm";
  $class_file{"PFBP::Reactant"} = "$data_dir/reactions/Reactant.mldbm";

  $class_file{"PFBP::Gene"} = "$data_dir/genes/Gene.mldbm";
  $class_file{"PFBP::Expression"} = "$data_dir/genes/Expression.mldbm";

  $class_file{"PFBP::Polypeptide"} = "$data_dir/polypeptides/Polypeptide.mldbm";
#  $class_file{"PFBP::Catalysis"} = "$data_dir/polypeptides/Catalysis.mldbm";
  ...
  sub open_class {
    my ($database, $class) = @_;
    $class_holder = PFBP::PersistentClass->new(class_file=>       $class_file{$class},
  ...
  sub get_id {
    ...
    my ($database, $query) = @_;
    my ($class, $key) = PFBP::DatabaseManagement->split_pseudo_pointer($query);
